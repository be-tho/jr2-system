...
<div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Total Artículos</p>
                <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $totalArticulos }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">En Stock</p>
                <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $enStock }}</p>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <div class="w-8 h-8 bg-accent-100 dark:bg-accent-900/20 rounded-lg flex items-center justify-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Stock Bajo</p>
                <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $stockBajo }}</p>
                <p class="text-sm text-accent-600 dark:text-accent-400">{{ $porcentajeStockBajo }}%</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Sin Stock</p>
                <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $sinStock }}</p>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <div class="w-8 h-8 bg-secondary-100 dark:bg-secondary-900/20 rounded-lg flex items-center justify-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Valor Total</p>
                <p class="text-xl font-bold text-neutral-900 dark:text-white">${{ number_format($valorTotal, 0, ',', '.') }}</p>
                <p class="text-sm text-secondary-600 dark:text-secondary-400">Inventario</p>
            </div>
        </div>
    </div>
</div>
