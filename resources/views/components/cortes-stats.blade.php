...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Total de Cortes</p>
                <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $totalCortes }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Cortados</p>
                <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $cortados }}</p>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Costurando</p>
                <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $costurando }}</p>
                <p class="text-sm text-accent-600 dark:text-accent-400">{{ $porcentajeCosturando }}%</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6 hover:shadow-md transition-all duration-200">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Entregados</p>
                <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $entregados }}</p>
