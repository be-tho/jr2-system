    ...
    <x-container-wrapp>
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-neutral-900 dark:text-white">Nueva Categoría</h1>
                    <p class="text-neutral-600 dark:text-neutral-400">Crea una nueva categoría para organizar tus productos</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                            <ul class="list-disc list-inside space-y-1">
                                <li>Usa nombres claros y concisos</li>
