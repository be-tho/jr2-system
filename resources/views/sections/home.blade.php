                ...
                @if(isset($cortesRecientes) && count($cortesRecientes) > 0)
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <a href="{{ route('cortes.show', $corte->id) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm">
                ...
                @if(isset($articulosPopulares) && count($articulosPopulares) > 0)
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                            ...
                            <a href="{{ route('articulos.show', $articulo->id) }}" class="text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300 text-sm">
                                <i class="ri-eye-line"></i>
                            </a>
                        </div>
                        @endforeach
