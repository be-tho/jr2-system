    ...
    <x-container-wrapp>
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-neutral-900 dark:text-white">Editar Temporada</h1>
                    <p class="text-neutral-600 dark:text-neutral-400">Modifica la información de la temporada "{{ $temporada->nombre }}"</p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-2xl">
            <div class="bg-white dark:bg-neutral-800 shadow-sm rounded-lg overflow-hidden">
                ...
                <form action="{{ route('temporadas.update', $temporada) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-6 p-4 bg-neutral-50 dark:bg-neutral-700 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <span class="ml-2 font-medium text-neutral-900 dark:text-white">#{{ $temporada->id }}</span>
                            </div>
                            <div>
                                <span class="text-neutral-500 dark:text-neutral-400">Creada:</span>
                                <span class="ml-2 font-medium text-neutral-900 dark:text-white">{{ $temporada->formatted_created_at }}</span>
                            </div>
                            <div>
                                <span class="text-neutral-500 dark:text-neutral-400">Última actualización:</span>
                                <span class="ml-2 font-medium text-neutral-900 dark:text-white">{{ $temporada->formatted_updated_at }}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                            <p>Al cambiar el nombre de una temporada, todos los artículos asociados se actualizarán automáticamente. Asegúrate de que el nuevo nombre sea apropiado para todos los productos de esta temporada.</p>
                        </div>
                    </div>
                </div>
            </div>
