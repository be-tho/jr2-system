        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex gap-3">
                    <x-buttons.outline href="{{ route('ventas.print', $venta) }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0">
                                                <img src="{{ \App\Helpers\ImageHelper::getArticuloImageUrl($item->articulo->getMainImage()) }}" 
                                                     alt="{{ \App\Helpers\ImageHelper::getDefaultImageAlt($item->articulo->getMainImage(), 'default-articulo.svg', $item->articulo->nombre, 'artículo') }}" 
                                                     class="w-10 h-10 object-cover rounded-lg flex-shrink-0 {{ \App\Helpers\ImageHelper::getDefaultImageClass($item->articulo->getMainImage(), 'default-articulo.svg') }}" 
                                                     onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                                <div class="w-10 h-10 bg-neutral-100 dark:bg-neutral-700 rounded-lg flex items-center justify-center" style="display: none;">
